...
import { 
  ...
  Heart, Share2, ExternalLink, Brain, Bell, Star, Sparkles
} from "lucide-react";
...
const mockJobs: Job[] = [
  ...
  },
  {
    ...
    posted: "1 week ago",
    description: "Represent indigent clients in criminal matters from arraignment through trial.",
    requirements: ["JD required", "AZ Bar admission", "Trial experience preferred"],
            ...
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex items-center gap-2 justify-center mb-4">
                <Badge className="bg-neon-green/20 text-neon-green border-neon-green/30">
                  <Star className="w-3 h-3 mr-1" /> 10/10 Rating
                </Badge>
              ...
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-neon-cyan/10 border border-neon-cyan/30 mb-6">
                ...
                <span className="text-sm font-medium text-neon-cyan">Legal Job Marketplace • Like LinkedIn AI Matching</span>
              </div>
              ...
              <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                ...
                Free postings, smart alerts, and career tools.
              </p>
            </div>
          </div>
        </section>
              ...
              <TabsContent value="alerts">
                <Card className="glass-card p-6">
                  ...
                  <p className="text-muted-foreground mb-4">
                    Get notified when new jobs match your criteria. AI analyzes your profile for perfect matches.
                  </p>
                  <div className="grid md:grid-cols-2 gap-4 mb-4">
                    <Input placeholder="Keywords (e.g., Corporate, M&A)" />
                    <Input placeholder="Location (e.g., New York)" />
                  </div>
                  <Button variant="neon-green" className="w-full gap-2">
          ...
          <div className="container mx-auto px-4">
            <div className="glass-card p-8 rounded-2xl border-neon-green/20 bg-gradient-to-r from-neon-green/5 to-neon-cyan/5 max-w-4xl mx-auto text-center">
              ...
              <p className="text-muted-foreground mb-6">
                Post your legal job openings FREE and connect with AI-matched candidates
              </p>
              <div className="flex justify-center gap-4">
                <Button variant="neon-green" size="lg" className="gap-2">
                  Post a Job Free <ExternalLink className="h-4 w-4" />
                </Button>
                <Button variant="outline" size="lg" className="gap-2">
                  <Sparkles className="h-4 w-4" /> Premium Posting
                </Button>
              </div>
            </div>
          </div>
